...
<script type="text/javascript">
	...
	$(document).ready(function(){
		layer.load();
		$.getJSON('<%=request.getContextPath()%>/cloud/getShareFolderTree.action',function(data){
			...
			if(!jQuery.isEmptyObject(data)){
				...
				layer.closeAll('loading');
				layer.alert('当前没有共享目录，请选择目录进行共享！', {icon: 0,closeBtn:false} ,function(){
		...
		<div class="col-md-3"> 
			<div class="panel panel-primary">
				<div class="panel-heading" style="font-weight:bolder">
	        		<a style="color:white;" href="cloudfolders.jsp">我的云目录</a>
	            </div>  
	       	</div>    
	        <div class="panel panel-primary" >
	        	<div class="panel-heading" style="font-weight:bolder">
