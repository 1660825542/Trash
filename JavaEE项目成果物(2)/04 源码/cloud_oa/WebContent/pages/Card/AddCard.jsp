...
<div class="container">
	...
	<!-- 侧边栏 -->     
     ...
     <div class="col-md-7">
        ...
        <form id="addForm" name="form1" method="post" action="<%=request.getContextPath()%>/Card/insert.action">
		   				...
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="container col-md-4">
			       					<input class="form-control col-xs-4" name="cardName" id="cardName" placeholder="请输入姓名"  nullmsg="请输入联系人姓名！" type="text">
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				...
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			                    	<input class="form-control" name="cardPhone" id="cardPhone" placeholder="请输入电话"  errormsg="电话必须为数字！" nullmsg="请输入电话！" type="text">
			       				</div>
			   				</div>
		   				</td>
		   			</tr>   				   				
		   				...
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
									<input class="form-control" name="cardPosition" id="posName"  placeholder="点击选择职务"  nullmsg="请选择职务！" type="text" readonly>
	   				...
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			 						<input class="form-control" name="cardDept" id="deptName"  placeholder="点击选择部门"  nullmsg="请选择部门！" type="text" readonly>
		   				...
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			 						<input class="form-control" name="cataName" id="cataName"  placeholder="点击选择名片类别"  nullmsg="请选择类别！" type="text" readonly>
