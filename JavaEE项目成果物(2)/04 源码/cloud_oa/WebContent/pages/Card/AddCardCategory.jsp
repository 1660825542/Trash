...
<div class="container">	
	<!-- 侧边栏 -->     
     ...
     <div class="col-md-7">
        ...
        <form name="form1" id="form1" method="post" action="<%=request.getContextPath() %>/CardCategory/insert.action">
                <table class="table table-striped" border="0" width="100%">
                  <tbody><tr>
                    <td>名称</td>
                    <td><input name="cataName" id="cataName" class="form-control" datatype="*" nullmsg="请输入名片夹类别名称！" errormsg="不能为空！" type="text"></td>
                  </tr>
                </tbody></table>
                <input value="保存分类" class="btn btn-primary btn-large" type="submit">
                <input value="返回" class="btn btn-success btn-large" type="button" onclick="history.back();">
