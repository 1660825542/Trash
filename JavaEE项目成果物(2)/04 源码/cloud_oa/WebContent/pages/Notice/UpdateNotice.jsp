...
<div class="container-fluid" style="margin:10px">
	<div class="row">
		<form id="updateNotice" class="form-horizontal" method="post" action="<%=request.getContextPath()%>/notice/update.action">
			
			<input type="hidden" value="${notice.noticeId}" name="noticeId" id="noticeId" class="form-control">
			<input type="hidden" value="${notice.empId}" name="empId" id="empId" class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" value="${notice.noticeTitle}" datatype="*" placeholder="请输入内容" name="noticeTitle" id="noticeTitle" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="radio col-sm-10" id="state">
					...
					<label for="radio2" class="radio-inline">
						<input type="radio" id="radio2" name="isTop" value="0">不置顶</label>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-10 col-sm-offset-2">
					<input type="submit" class="btn btn-primary btn-block" id="transmit" value="确定修改">
				</div>
			</div>
		</form>			
	</div>					
