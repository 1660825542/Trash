...
<title>添加派遣记录</title>
	...
	function selectEmp() {
		layer.open({
			...
			area : ['700px' , '500px'],
			content: ['<%=request.getContextPath()%>/assemp/selectEmp.action?', 'no'],
...
<div class="container">
	...
	<!-- 右侧内容-->
	<div class="col-md-7">
		<h3 class="page-header">新增外派记录</h3>

		<form id="form1" class="form-horizontal" method="post" action="<%=request.getContextPath() %>/empcom/insertByEmpCom.action?pageNum=${param.pageNum}">
			...
			<div class="form-group" style="margin-top:10px">
				...
				<div class="col-sm-10">
					<input datatype="*" type="text" class="form-control" onclick="selectEmp();" readonly="readonly" name="assName " id="assName"></div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input datatype="*" type="text" class="form-control" readonly="readonly" onclick="selectCom();" name="comName " id="comName" ></div>
			</div>
