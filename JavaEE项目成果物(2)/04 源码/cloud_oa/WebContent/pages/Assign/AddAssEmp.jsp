...
<div class="container">
	...
	<!-- 右侧内容-->
	<div class="col-md-7">
		<h3 class="page-header">新增外派人员</h3>

		<form id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" action="<%=request.getContextPath() %>
			/assemp/insert.action?pageNum=${param.pageNum}">
			<div class="form-group">
				<label class="col-sm-2 control-label float-left">员工姓名</label>
				<div class="col-sm-10">
					<input datatype="s1-10" errormsg="姓名最多10字符" class="form-control col-sm-5" name="assemp.assName " id="assName" placeholder="姓名"></div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label">教育经历</label>
				<div class="col-sm-10">
					<input datatype="*" errormsg="请填写教育经历" type="text" class="form-control" name="assemp.education " id="education" placeholder="学历"></div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label">工作经验</label>
				<div class="col-sm-10">
					<input datatype="s1-10" errormsg="请填写工作经验" type="text" class="form-control" name="assemp.workExp " id="workExp" placeholder="工作经验"></div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label ">技能特长</label>
				<div class="col-sm-10">
					<input type="text" type="text" datatype="*" errormsg="请填写技能特长" class="form-control" name="assemp.skill " id="skill" placeholder="技能特长"></div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label ">户口所在</label>
				<div class="col-sm-10">
					<input type="text" datatype="*" errormsg="请填写户口所在地" class="form-control" name="assemp.residentCity " id="residentCity" placeholder="户口所在"></div>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label ">工资</label>
				<div class="col-sm-10">
					<input type="text" datatype="n" class="form-control" name="assemp.salary " id="salary" placeholder="工资状态"></div>
			</div>
			...
			<div class="form-group" style="margin-top:10px">
				...
				<div class="col-sm-10">
					<div class="file">
						<input type="file" class="form-control" name="data" id="resume"></div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="radio col-sm-10">
					<label for="radio1" class="radio-inline">
						<input type="radio" id="radio1" name="assemp.available" value="闲置中" checked>闲置中</label>
