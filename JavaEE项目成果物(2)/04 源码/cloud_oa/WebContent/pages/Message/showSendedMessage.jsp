        	...
        	<dropdown class="col-xs-12" style="margin-bottom:30px;"> 
				...
				<ul class="animate">
	                ...
	                <a href="<%=request.getContextPath()%>/message/showSendedMessage.action">
	                	<li class="animate actived">发件箱<i class="fa fa-code float-right"></i></li>
	                </a>
			...
			<div class="row">        	
            	<div class="col-sm-6">
					&nbsp;
		      		...
		      		<label>全选</label>
		      		&nbsp;
		          	<input id="delete" type="button" value="删除" class="btn btn-primary btn-sm" onclick="submitList('deleteSendedMessage.action');">
     			</div>
     			
     			<form method="post" action="<%=request.getContextPath()%>/message/querySendedMessage.action#" class="form-group">            	
