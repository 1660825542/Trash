...
<head>
	...
	<script type="text/javascript">
		function detail(leaveId){
			layer.load();
			$('#leaveDetail').load('<%=request.getContextPath()%>/leave/queryById.action?leaveId='+leaveId,
					function(){
...
<body>
			...
			<div class="col-md-9">
                ...
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <c:forEach items="${list}" var="leave">									
		                <tr>
		                	<td>${leave.leaveId }</td>
		                	<td>${leave.leaderName }</td>
		                  	<td><fmt:formatDate value="${leave.startTime}" pattern="yyyy年MM月dd日"/></td>
		                  	<td><fmt:formatDate value="${leave.endTime}" pattern="yyyy年MM月dd日"/></td>
		                  	...
		                  	<td><fmt:formatDate value="${leave.time}" pattern="yyyy年MM月dd日"/></td>
		                  	<td>
			                	<a href="javascript:detail(${leave.leaveId})" class="btn btn-default btn-xs">详请</a>     
		                  	</td>
		                </tr>		                
		                </c:forEach>
                     </tbody>
			    ...
			    <div class="col-sm-offset-9">
		    		...
		    		<a class="btn btn-primary btn-block" href="<%=request.getContextPath()%>/pages/leave/addLeave.jsp">发起新请假申请</a>
	...
	<!--网页底部结束-->
	<div class="modal fade" id="leaveInfo" tabIndex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
