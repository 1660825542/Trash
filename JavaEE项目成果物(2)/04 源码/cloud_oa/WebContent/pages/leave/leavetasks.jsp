...
<head>
	...
	<script type="text/javascript">
		function handle(taskId,recordId,procinsId){
			...
			$('#leaveDetail').load('<%=request.getContextPath()%>/leave/queryById.action?leaveId='+recordId,
					function(){
        	...
        	<div class="modal-content">
                ...
                <div class="modal-footer">
                	<div id="handleOpinion">
                		<form id="handleForm" class="form-group" method="post" action="<%=request.getContextPath()%>/processleave/handleTask.action">
