	...
	function add(){
		...
		$('#posAdd').click(function(){
			...
			if($('#posName').val()==null || $('#posName').val()=='' || $('#posName').val().length>16 ||  $('#posInformation').val().length>66)
			{
				...
				$.post('<%=request.getContextPath()%>/pos/insert.action',{posName:posNameForm,posInfo:posInfoForm},
						function(data){
					$('tbody').append('<tr><td>'+data+'</td><td>'+posNameForm+
							'</td><td>'+posInfoForm+'</td><td><a href="javascript:update('+data
									+');" data-original-title title><input class="btn btn-default btn-xs" type="button" value="修改" >'
									+'</a><a href="javascript:del('+data+' );" data-original-title title><input id="'+data
		                ...
		                <tr>
		                  	...
		                  	<td>
		                  		<a href="javascript:update(${pos.posId });">
		                  			<input id="${pos.posId }" class="btn btn-default btn-xs" type="button" value="修改" >
		                  		</a>
