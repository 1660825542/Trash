...
<body>
	...
	<!-- 侧边栏 -->     
		...
		<div class="col-md-9">
            ...
            <form id="addForm" name="form1" method="post" action="<%=request.getContextPath()%>/emp/edit.action?pageNum=${param.pageNum}">
					...
					<tr class="hidden-lg">
						<td>
			            	<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			       					<input name="empId" id="empId" class="form-control" value="${emp.empId }" placeholder="编号自动生成，无需填写" readonly="readonly" type="text">
			       				</div>
			   				</div>
			   			</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				<label class="col-md-offset-2 col-xs-2 control-label float-left">姓名</label>
			       				<div class="container col-md-4">
			       					<input class="form-control col-xs-4" name="empName" id="empName" value="${emp.empName }" placeholder="姓名勿改！" datatype="*" nullmsg="请输入员工姓名！" type="text" readonly>
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				<label class="col-md-offset-2 col-xs-2 control-label float-left">登录用户名</label>
			       				<div class="col-md-4">
			                    	<input class="form-control" name="empNum" id="empNum" value="${emp.empNum }" placeholder="用户名勿改！" readonly datatype="*" nullmsg="请输入用户名！" type="text">
			       				</div>
			   				</div>
		   				</td>
	   				</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				<label class="col-md-offset-2 col-xs-2 control-label float-left">密码</label>
			       				<div class="col-md-4">
			                    	<input class="form-control" name="password" id="password" placeholder="如不需修改请勿填写！" datatype="*" ignore="ignore" nullmsg="请输入密码！" type="text">
			       				</div>
			   				</div>
		   				</td>
	   				</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				<label class="col-md-offset-2 col-xs-2 control-label float-left">性别</label>
			       				<div class="col-md-4">
			       					<div class="radio">
					                   	...
					                   	<c:if test="${emp.gender==0 }">
					                        <label for="radio2" class="radio-inline">
					                            <input type="radio" id="genderFamale" name="gender" value="0" checked>女</label>
				                    	</c:if>
				                    </div>
			       				</div>
			   				</div>
	   				...
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			                   		<input class="form-control" name="birthday" id="birthday" value="${emp.birthday }" placeholder="点击选择生日" datatype="*" nullmsg="请选择生日！" type="text" readonly>
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			                    	<input class="form-control" name="phone" id="empPhone" value="${emp.phone }" placeholder="请输入电话" datatype="/^1[345678]\d{9}$/" errormsg="电话必须为数字！" nullmsg="请输入电话！" type="text">
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			                    	<input class="form-control" name="email" id="email" value="${emp.email }" datatype="e" placeholder="请输入电子邮箱" errormsg="邮箱格式不正确！" nullmsg="请输入邮箱！" type="text">
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			                    	<input class="form-control" name="qq" id="qq" value="${emp.qq }" datatype="n" ignore="ignore" placeholder="请输入QQ" type="text">
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
			 						<input class="form-control" name="deptName" id="deptName" value="${deptName }" datatype="*" placeholder="点击选择部门"  nullmsg="请选择部门！" type="text" readonly>
			                        <input name="departmentId" id="departmentId" value="${emp.departmentId }" type="hidden">
			                    </div>
			                    <div class="col-md-2">
			                    	<input id="chooseDept" value="修改部门" class="btn btn-primary" type="button">
			       				</div>
			   				</div>
		   				</td>
		   			</tr>
	   				<tr>
		   				<td>
			   				<div class="form-group"> 
			       				...
			       				<div class="col-md-4">
									<input class="form-control" name="posName" id="posName" value="${posName }" datatype="*" placeholder="点击选择职务"  nullmsg="请选择职务！" type="text" readonly>
			                        <input name="positionId" id="positionId" value="${emp.positionId }" type="hidden">
			                    </div>
			                    <div class="col-md-2">
			                       	<input id="choosePos" value="修改职务" class="btn btn-primary" type="button">
			                    </div>
			   				</div>
		   				</td>
		   			</tr>
