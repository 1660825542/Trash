	...
	<script type="text/javascript">
		...
		function create_users_pagenav(data){
			...
			var prePageLi = $("<li></li>").append(
					$("<a></a>").append("&laquo;"));
			if (data.dbinfo.pageInfo.hasPreviousPage) {
				...
				prePageLi.click(function() {
					toPage(data.dbinfo.pageInfo.pageNum - 1);
				});
			}
			...
			if (data.dbinfo.pageInfo.hasNextPage == false) {
				...
				lastPageLi.click(function() {
					toPage(data.dbinfo.pageInfo.pages);
				});
			}
			ul.append(firstPageLi).append(prePageLi);
			$.each(data.dbinfo.pageInfo.navigatepageNums, function(index,item) {
				var numLi = $("<li></li>").append($("<a></a>").append(item));
				if (data.dbinfo.pageInfo.pageNum == item) {
			...
			navEle.appendTo('#nav_users_info');
		}
	</script>
</body>
</html>