...
public class UserAction {
	...
	public Message getUsersByCpage(@RequestParam(value="cpage",defaultValue="1")String cpage){
		return userinfoService.queryAll(cpage);
	}
	/*@ResponseBody
	@RequestMapping(value="/users",method=RequestMethod.DELETE)
	public Message getUsersByCpage1(@RequestParam(value="cpage",defaultValue="1")String cpage){
		List<Userinfo> all=userinfoService.queryAll(cpage);
		return all;
	}
	@ResponseBody
	@RequestMapping(value="/users",method=RequestMethod.PUT)
	public Message getUsersByCpage2(@RequestParam(value="cpage",defaultValue="1")String cpage){
		List<Userinfo> all=userinfoService.queryAll(cpage);
		return all;
	}*/
}
