...
<div class="topper">
		<div class="wrap">
			...
			<div class="right">
				<a class="Mine.jsp" href="#" onclick="login();" title="用户中心">
					<i class="icon icon-login"></i>
					个人中心
				</a> 
				<a class="iconbounce" href="${pageContext.request.contextPath }/ShowOrder_Servlet?now_page=1" title="我的BTS">
				...
				<a class="iconbounce cart2" href="ShowShopping_Servlet" title="购物车">
